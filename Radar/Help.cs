...
namespace Radar
{
    ...
    public class Help : IFilter
    {
        ...
        public Help(List<Position> realPositions, List<Position> noisePositions, List<SphericalPosition> noiseSphericalPosition, List<Position> filterOutput)
        {
        ...
        public Help(List<Position> noisePositions, List<Position> filterOutput)
        {
            NoisedPositions = noisePositions;
            FilterOutputPositions = filterOutput;
