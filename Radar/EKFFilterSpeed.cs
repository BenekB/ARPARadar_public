...
namespace Radar
{
    class EKFFilterSpeed
    {
        ...
        public EKFFilterSpeed(List<Position> realPositions, List<Position> noisePositions, List<Position> filterOutput)
        {
        ...
        public EKFFilterSpeed(List<Position> noisePositions, List<Position> filterOutput)
        {
            NoisedPositions = noisePositions;
            FilterOutputPositions = filterOutput;
        ...
        public EKFFilterSpeed(string path)
        {
        ...
        {
            //  Jeżeli mamy mniej niż 12 próbek, to nic się nie dziej - za mało danych
            if (NoisedPositions.Count < 12) return;
            N = NoisedPositions.Count; // +12
        ...
        public void InitializeDefault()
        {
            ...
            Q = new Matrix(new double[,] { {    .01,  0,  0,  0   },
                                           {    0,  .01,  0,  0   },
                                           {    0,  0,  .01,  0   },
                                           {    0,  0,  0,  0.001   }   });
